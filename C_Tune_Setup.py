...
class Ui_C_Tune_Setup(object):     

    def setupUi(self, C_Tune_Setup):
        C_Tune_Setup.setObjectName("C_Tune_Setup")
        C_Tune_Setup.resize(313, 364)
        self.centralwidget = QtWidgets.QWidget(C_Tune_Setup)
        ...
        C_Tune_Setup.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(C_Tune_Setup)
        self.statusbar.setObjectName("statusbar")
        C_Tune_Setup.setStatusBar(self.statusbar)

        self.retranslateUi(C_Tune_Setup)
        QtCore.QMetaObject.connectSlotsByName(C_Tune_Setup)

    def retranslateUi(self, C_Tune_Setup):
        _translate = QtCore.QCoreApplication.translate
        C_Tune_Setup.setWindowTitle(_translate("C_Tune_Setup", "C Load"))
        self.groupBox.setTitle(_translate("C_Tune_Setup", "Range"))
        self.groupBox_2.setTitle(_translate("C_Tune_Setup", "Step size"))
        self.groupBox_3.setTitle(_translate("C_Tune_Setup", "Start value"))
    ...
    def get_start_value(self):
        ...
        Ui_C_Tune_Setup.start_value = text

if __name__ == "__main__":
    app = QtWidgets.QApplication(sys.argv)
    C_Tune_Setup = QtWidgets.QMainWindow()
    ui = Ui_C_Tune_Setup()
    ui.setupUi(C_Tune_Setup)
    C_Tune_Setup.show()
    sys.exit(app.exec_())