...
class Ui_L_Tune_Setup(object):    

    def setupUi(self, L_Tune_Setup):
        L_Tune_Setup.setObjectName("L_Tune_Setup")
        L_Tune_Setup.resize(313, 364)
        self.centralwidget = QtWidgets.QWidget(L_Tune_Setup)
        ...
        L_Tune_Setup.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(L_Tune_Setup)
        self.statusbar.setObjectName("statusbar")
        L_Tune_Setup.setStatusBar(self.statusbar)

        self.retranslateUi(L_Tune_Setup)
        QtCore.QMetaObject.connectSlotsByName(L_Tune_Setup)

    def retranslateUi(self, L_Tune_Setup):
        _translate = QtCore.QCoreApplication.translate
        L_Tune_Setup.setWindowTitle(_translate("L_Tune_Setup", "C Load"))
        self.groupBox.setTitle(_translate("L_Tune_Setup", "Range"))
        self.groupBox_2.setTitle(_translate("L_Tune_Setup", "Step size"))
        self.groupBox_3.setTitle(_translate("L_Tune_Setup", "Start value"))
    ...
    def get_start_value(self):
        ...
        Ui_L_Tune_Setup.start_value = text

if __name__ == "__main__":
    app = QtWidgets.QApplication(sys.argv)
    L_Tune_Setup = QtWidgets.QMainWindow()
    ui = Ui_L_Tune_Setup()
    ui.setupUi(L_Tune_Setup)
    L_Tune_Setup.show()
    sys.exit(app.exec_())